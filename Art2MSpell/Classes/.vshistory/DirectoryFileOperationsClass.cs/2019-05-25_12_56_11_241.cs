...
namespace Art2MSpell.Classes
{
    ...
    public static class DirectoryFileOperationsClass
    {
        ...
        public static bool CreateUserSpellingListDirectory(string dirPath)
        {
            ...
            {
                MyMessages.ErrorMessage = "One or both directory path strings are null. Make sure you are in the" +
                                          " list of users";
            ...
            {
                MyMessages.ErrorMessage = "The directory path is to long. Check path to user folder.";
        ...
        /// <changed>art2m,5/23/2019</changed>
        /// ********************************************************************************
        public static string CombineStringsMakeDirectoryPath(string first, string second, string third, string fourth)
        {
            try
            {
                MyMessages.NameOfMethod = MethodBase.GetCurrentMethod().Name;
