...
namespace Art2MSpell.Classes
{
    ...
    public  class Validation
    {
        ...
        public  bool ValidateSpellingWord([NotNull] string value)
        {
            ...
            if (!this.ValidateStringValueNotEmptyNotWhiteSpace(value))
            {
                return false;
            }

            if (!this.ValidateStringOneWord(value))
            {
                return false;
            }

            return this.ValidateSpellingWordHasLettersOnly(value);
        }
        ...
        public  bool ValidateThisIsArt2MSpellSpellingList([NotNull] string word)
        {
            ...
            if (!this.ValidateStringValueNotEmptyNotWhiteSpace(word))
            {
                return false;
            }
