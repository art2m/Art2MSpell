...
namespace Art2MSpell.Collections
{
    class UserSpellingFilePathsCollection : ISpellingWordsCollection
    {
        ...
        /// </summary>
        private static readonly List<string> spList = new List<string>();
