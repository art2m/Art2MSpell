...
namespace Art2MSpell.Collections
{
    ...
    public static class UserSpellingFilesDicCollection
    {
        ...
        /// <summary>
        /// the dictionary collection container for users spelling list paths.
        /// </summary>
        /// <typeparam name="string">Users Name</typeparam>
        /// <typeparam name="string">Users spelling list paths.</typeparam>
        /// <returns></returns>
        ...
        /// <summary>
        /// Add user name and user spelling list file paths to the collection.
        /// </summary>
        /// <param name="keyItem">The users name.</param>
        /// <param name="valueItem">the file path to the users spelling lists.</param>
        /// <created>art2m,5/21/2019</created>
        /// <changed>art2m,5/21/2019</changed>
