...
namespace Art2MSpell.Source
{
    ...
    public partial class UserNameEditDeleteForm : Form
    {
        ...
        private void OnDeleteUserButton_Click(object sender, EventArgs e)
        {
            ...
            var userDirPath = DirectoryFileOperations.CombineStringsMakeDirectoryPath(dirPath, dirName);
            ...
            var path = SpellingPropertiesClass.GetArt2MSpellUserListFileName;

            var filePath = 
                DirectoryFileOperations.CombineDirectoryPathFileNameCheckCreateFile(pathArt2MSpell, fileName);
