...
namespace Art2MSpell.Source
{
    ...
    public partial class UserNameEditDeleteForm : Form
    {
        ...
        private void OnDeleteUserButton_Click(object sender, EventArgs e)
        {
            ...
            var retVal = GetAllUserNamesFile(userDirPath);
            ...
            retVal = ReadTheUserNameFileIntoCollection();
        ...
        private bool ReadTheUserNameFileIntoCollection()
        {
        ...
        /// <changed>art2m,5/23/2019</changed>
        /// ********************************************************************************
        private bool GetAllUserNamesFile(string userDirPath)
        {
