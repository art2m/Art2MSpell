...
namespace Art2MSpell.Source
{
    ...
    public partial class SpellingWordsListForm : Form
    {
        ...
        {
            var Words = SpellingReadWriteClass.ReadSpellingListFile(SpellingPropertiesClass.SpellingListPath);
        ...
        private void SaveSpellingWordsToSpellingList()
        {
            ...
            SpellingWordsListClass.SaveSpellingListPath(Words);

            SetSaveOperationProperties();
