...
namespace Art2MSpell.Source
{
    ...
    public partial class Art2MSpellMainForm : Form
    {
        ...
        private static void GetPathToAppDataDirectory()
        {
            ...
            catch (ArgumentNullException ex)
            {
                MyMessagesClass.ErrorMessage = 
                    Resources.Art2MSpellMainForm_GetPathToAppDataDirectory_Unable_to_locate_the_AppData_directory_;
            ...
            {
                MyMessagesClass.ErrorMessage =
                    Resources.Art2MSpellMainForm_GetPathToAppDataDirectory_Unable_to_locate_the_AppData_Directory;
            ...
            {
                MyMessagesClass.ErrorMessage = 
                    Resources.Art2MSpellMainForm_GetPathToAppDataDirectory_This_platform_does_not_support_this_type_of_directory_find_;
        ...
        {
            // TODO: Add code for showing form to delete all spelling lists or a spelling list..
        }
