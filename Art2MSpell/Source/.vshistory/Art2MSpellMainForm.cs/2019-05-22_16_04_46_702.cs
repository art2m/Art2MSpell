...
namespace Art2MSpell.Source
{
    ...
    public partial class Art2MSpellMainForm : Form
    {
        ...
        private void SpellItMainForm_Resize(object sender, EventArgs e)
        {
            ...
            var tHeight = this.grpUserControls.Height + this.pnlSpellingControls.Height + this.space;

            var half = this.grpUserControls.h
            this.grpUserControls.Top = this.ClientSize.Height / 2;
