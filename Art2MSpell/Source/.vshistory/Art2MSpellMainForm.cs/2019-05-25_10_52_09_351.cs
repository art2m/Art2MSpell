...
namespace Art2MSpell.Source
{
    ...
    public partial class Art2MSpellMainForm : Form
    {
        ...
        private static void GetPathToAppDataDirectory()
        {
            ...
            {
                MyMessagesClass.ErrorMessage = Resources.Art2MSpellMainForm_GetPathToAppDataDirectory_Unable_to_locate_the_AppData_directory_;
            ...
            {
                MyMessagesClass.ErrorMessage = "Unable to locate the AppData Directory";
            ...
            {
                MyMessagesClass.ErrorMessage = "This platform does not support this type of directory find.";
