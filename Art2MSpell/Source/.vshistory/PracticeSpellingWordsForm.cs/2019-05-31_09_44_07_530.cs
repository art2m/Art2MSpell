...
namespace Art2MSpell.Source
{
    ...
    public partial class PracticeSpellingWordsForm : Form
    {
        ...
        private void OnNextWordButtonClick(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txtSpellWord.Text.Trim()))
            {
                OnRepeatWordButtonClick(null, null);
                return;
            }

            CheckWordSpelling();

            txtSpellWord.Text = string.Empty;
            ChangeControls_BackgroundColors();
            ShowWordsScore();
            ...
            {
                SetButtonsEnabledState_NextWordButtonClicked();
                SetNextWordButton_BackgroundColor();
                SetPauseButton_BackgroundColor();
                SetRepeatWordButton_BackgroundColor();
                SetQuitButton_BackgroundColor();
