...
namespace Art2MSpell.Classes.Tests
{
    ...
    public class DirectoryFilesOperationTest
    {
        ...
        /// ********************************************************************************
        [TestMethod()]
        public void CreateUserSpellingListDirectoryTest_Valid_TestDirectoryExistsOrIsCreated()
        {
            // Assign
        ...
        /// ********************************************************************************
        [TestMethod()]
        public void CheckDirectoryExistsCreateDirectoryTest_True()
        {
            // Assign
            var dirPath = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData);
            // Act
        ...
        /// ********************************************************************************
        [TestMethod()]
        public void CombineStringsMakeDirectoryPathTest_CombineTwoDirectories()
